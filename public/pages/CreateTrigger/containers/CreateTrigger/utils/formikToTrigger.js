  ...
  if (anomalyDetector.triggerType === TRIGGER_TYPE.AD) {
    ...
    return {
      script: {
        ...
        source: `return ${ANOMALY_GRADE_RESULT_PATH} ${anomalyGradeOperator} ${
          anomalyDetector.anomalyGradeThresholdValue
        } && ${ANOMALY_CONFIDENCE_RESULT_PATH} ${anomalyConfidenceOperator} ${
