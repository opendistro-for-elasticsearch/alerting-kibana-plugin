  ...
  if (isAd && adTriggerType === TRIGGER_TYPE.AD) {
    triggerContent = (
      <AnomalyDetectorTrigger
        ...
        adValues={triggerValues.triggerConditions[index].anomalyDetector}
      />
    );
  }
  if (isGraph) {
    triggerContent = (
      <TriggerGraph
        ...
        thresholdEnum={triggerValues.triggerConditions[index].thresholdEnum}
        thresholdValue={triggerValues.triggerConditions[index].thresholdValue}
      />
    );
  }
